      ...
      <section className="pt-32 pb-24 border-b border-border bg-background">
        <div className="container mx-auto px-6">
          <div className="max-w-7xl mx-auto">
            <h1 className="text-minimal text-primary mb-4">01</h1>
            <h2 className="text-4xl md:text-5xl font-light text-architectural text-foreground mb-16">
              Who Are We?
            </h2>
            <div className="grid md:grid-cols-2 gap-16">
              ...
              <div className="space-y-8">
                <div>
                  <h3 className="text-minimal text-primary mb-6">OUR APPROACH</h3>
                  <div className="space-y-5">
                    <div className="border-l-2 border-primary pl-6">
                      <h4 className="text-lg font-medium mb-1 text-foreground">Integrity & Innovation</h4>
                    ...
                    <div className="border-l-2 border-primary pl-6">
                      <h4 className="text-lg font-medium mb-1 text-foreground">Quality & Reliability</h4>
                      <p className="text-sm text-muted-foreground">Stringent quality control with state-of-the-art manufacturing facilities</p>
                    </div>
                    <div className="border-l-2 border-primary pl-6">
                      <h4 className="text-lg font-medium mb-1 text-foreground">Customer Satisfaction</h4>
                ...
                <div className="pt-6 border-t border-border">
                  <div className="grid grid-cols-2 gap-8">
                    <div>
                      <h4 className="text-minimal text-primary mb-2">FOUNDED</h4>
                      <p className="text-2xl font-semibold text-foreground">1999</p>
                    </div>
                    <div>
                      <h4 className="text-minimal text-primary mb-2">PROFESSIONALS</h4>

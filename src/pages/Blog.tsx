...
const Blog = () => {
  ...
  const categories = ["ALL", "AMR", "MICROBIOME", "GENOMICS"];
          ...
          <div className="max-w-7xl mx-auto">
            <div className="mb-12">
              ...
              <p className="text-xl text-muted-foreground max-w-3xl">
                Exploring the frontiers of microbiology through scientific analysis,
                research highlights, and perspectives on emerging discoveries.
              </p>
            </div>
          </div>
        </div>
        ...
        <div className="container mx-auto px-6">
          <div className="max-w-4xl mx-auto text-center">
            ...
            <p className="text-xl text-muted-foreground mb-12">
              Subscribe to our newsletter for the latest insights on microbiology research
            </p>
